        ...
        <section class="projects-section bg-light " id="projects">
            <div class="container px-4 px-lg-5">
                ...
                <div class="row gx-0 mb-4 mb-lg-5 align-items-center">
                    <div class="col-xl-8 col-lg-7"><img class="img-fluid img-thumbnail mb-3 mb-lg-0" src="assets/images/services.jpg" alt="..." /></div>
                    <div class="col-xl-4 col-lg-5">
                        <div class="featured-text text-center text-lg-left">
                            <h4>ABOUT US</h4>
                            <p class="text-black-100 mb-2 ">
                        ...
                        <div class="carousel-inner py-4">
                            ...
                            <div class="carousel-item active">
                                <div class="container">
                                    <div class="row">
                                        <div class="col-lg-4">
                                            <div class="card shadow" style="width: 20 rem:">
                                                <div class="center1"> 
                                                <img src="assets/images/baked-scallops.png" class="card-img-top img-fluid d-block m-x-auto" alt="...">
                                                </div>
                                        ...
                                        <div class="col-lg-4 ">
                                            <div class="card shadow" style="width: 20 rem:">
                                                 <div class="center1"> 
                                                    <img src="assets/images/lubster2.png" class="card-img-top img-fluid d-block m-x-auto" alt="...">
                                                        </div>
                                        ...
                                        <div class="col-lg-4 ">
                                            <div class="card shadow" style="width: 20 rem:">
                                            <div class="center1"> 
                                                    <img src="assets/images/octupos-suite.jpg" class="card-img-top img-fluid d-block m-x-auto" alt="...">
                                                        </div>
                                ...
                                <div class="container">
                                    <div class="row">
                                        <div class="col-lg-4 ">
                                            <div class="card shadow" style="width: 20 rem:">
                                                <div class="center1">
                                                <img src="assets/images/lumi2.png" class="card-img-top img-fluid d-block m-x-auto"alt="...">
                                                </div>
                                        ...
                                        <div class="col-lg-4 ">
                                            <div class="card shadow" style="width: 20 rem:">
                                            <div class="center1">
                                            <img src="assets/images/sauted-abalone.png" class="card-img-top img-fluid d-block m-x-auto" alt="...">
                                                </div>
                                            <div class="card-body">
...
<section class="menu-section text-center" id="gallery">
 <div class="container">
        ...
        <section class="gallery-section text-center" id="gallery">
            <div class="container px-4 px-lg-5">
                ...
                <div class="lightbox"> 
                    ...
                    <div class="row ">
                        <div class="col-lg-4">
                            <img src="assets/images/bg-head.jpg"  class="img fluid w-100 shadow-1-strong rounded mb-4 img thumbnail">
                        ...
                        <div class="col-lg-4">
                            ...
                            <img src="assets/images/carousel1.jpg"  class="img fluid w-100 shadow-1-strong rounded mb-4 img thumbnail">
                        </div>

                        <div class="col-lg-4">
                            <img src="assets/images/carousel3.jpg"  class="img fluid w-100 shadow-1-strong rounded mb-4 img thumbnail">

                            
                        </div>
                        <div class="col-lg-4">
                            <img src="assets/images/contact.jpg" class="img fluid w-100 shadow-1-strong rounded mb-4 img thumbnail">
                        </div>

                        <div class="col-lg-4">
                            <img src="assets/images/menus.jpg"  class="img fluid w-100 shadow-1-strong rounded mb-4 img thumbnail" >
                        </div>
                        <div class="col-lg-4">
                            <img src="assets/images/services.jpg"  class="img fluid w-100 shadow-1-strong rounded mb-4 img thumbnail">
                        </div>
                    </div>
                </div>
        ...
        <div class="featured-text text-center">
            ...
            <div class="bg-info contact4 overflow-hidden position-relative">
                <div class="row no-gutters">
                    ...
                    <div class="col-lg-6 right-image p-r-1">
                    
                   <!--col-lg-6 right-image p-r-0-->
